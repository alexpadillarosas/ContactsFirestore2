...
class ViewContactTVController: UITableViewController {
...
*/
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let editContactTVController = segue.destination as? EditContactTVController{
            editContactTVController.contact = self.contact
